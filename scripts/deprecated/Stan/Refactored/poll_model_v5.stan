...
transformed data {
  row_vector[S] rv_mu_b_prior;
  matrix[S, S] cholesky_ss_correlation;
...
parameters {
  ...
  matrix[T, S] raw_mu_b; // S state-specific components at time T
  // mu_c
