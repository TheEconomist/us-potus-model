...
n_two_share_national <- df %>% filter(index_s == 52) %>% transmute(n_two_share = n_obama + n_romney) %>% pull(n_two_share)
n_two_share_state <- df %>% filter(index_s != 52) %>% transmute(n_two_share = n_obama + n_romney) %>% pull(n_two_share)
