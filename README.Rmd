...
* `poll_model_2020_no_partisan_correction.stan` - a model that removes the correction for partisan non-response bias in the polls
* `poll_model_2020_no_mode_adjustment.stan` - a model that further removes the adjustments for the mode in which a survey is conducted (live phone, online, other) and its population (adult, likely voter, registered voter)
...
# final model version
# source('scripts/model/final_2016.R');source('scripts/model/final_2012.R');source('scripts/model/final_2008.R');rmarkdown::render('README.Rmd',output_file = 'README.md');beepr::beep(2);
```
