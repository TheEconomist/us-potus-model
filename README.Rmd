...
subtitle: "From _The Economist_, Merlin Heidemanns and Andrew Gelman"
...
# final model version
# source('scripts/model/poll_model_2020.R');source('scripts/model/final_2012.R');source('scripts/model/final_2008.R');rmarkdown::render('model_summary.Rmd',output_file = 'model_reports/v3_add_baseline_cov');beepr::beep(2);
```
