...
# final model version
# source('scripts/model/poll_model_2020.R');source('scripts/model/final_2012.R');source('scripts/model/final_2008.R');rmarkdown::render('model_summary.Rmd',output_file = 'model_reports/v2_new_prior_optimized_covar_0.6cor_newcovmat_cor_average_student_t');beepr::beep(2);
```
