...
# model version final:
# source('scripts/R/Backtesting/final_2008.R');source('scripts/R/Backtesting/final_2012.R');source('scripts/model/poll_model_2020.R');rmarkdown::render('model_summary.Rmd',output_file = 'model_reports/final_final_actual_new_prior_optimized_covar_0.6cor_newcovmat_cor_average.html');beepr::beep(2);
```
