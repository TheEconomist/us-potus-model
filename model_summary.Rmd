...
# source('scripts/R/Refactored/poll_backtest_2008.R');source('scripts/R/Refactored/poll_backtest_2012.R');source('scripts/R/Refactored/poll_run_v7.R');rmarkdown::render('model_summary.Rmd');beepr::beep(2);beepr::beep(2)
```
